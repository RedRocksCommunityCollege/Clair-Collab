#This code is ideal for mathing .csv files.

import numpy as np
import pandas as pd

#Create a data frame by reading .csv in using pandas module
#df = pd.read_csv("/home/adam/GitHub/RedRocksCommunityCollege/Clair-Global-Collab/Data/Test_Data/RECS2009/recs2009_public.csv")#Adam's filepath
df = pd.read_csv("/Users/K8nn8/Google Drive/RRCC DataLab/Clair-Global-Collab/Data/Test_Data/RECS2009/recs2009_public.csv")#Cory's filepath
...
Houses = np.array([[0,0,0,0,0]]) # Make an empty array. We need [0,0] for the correct shape.
